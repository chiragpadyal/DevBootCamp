...
export const Login = (props) => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            <div className="my-3 text-4xl font-bold tracking-wider text-center">
              <Link to="/DevBootCamp"> DevBootCamp</Link>
            </div>
            <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">
              With the power of DevBootCamp, you can now focus only on
            ...
            <p className="flex flex-col items-center justify-center mt-10 text-center">
              {props.value == "signup" ? (
                <>
                  ...
                  <Link to="/DevBootCamp/login" className="underline">
                    Login!
                  </Link>
                </>
              ) : (
                <>
                  ...
                  <Link to="/DevBootCamp/signup" className="underline">
                    Get Started!
                  </Link>
                </>
              )}
          ...
          <div className="p-5 bg-white md:flex-1">
            <h3 className="my-4 text-2xl font-semibold text-gray-700">
              Account {props.value == "signup" ? "Signup" : "Login"}
            </h3>
              ...
              <div className="flex flex-col space-y-5">
                <span className="flex items-center justify-center space-x-2">
                  ...
                  <span className="font-normal text-gray-500">
                    or {props.value == "signup" ? "Signup" : "Login"} with
                  </span>
                  <span className="h-px bg-gray-400 w-14"></span>
                </span>
      ...
      {modal ? <Modalforgetpass value={showmodal} /> : ""}
    </>
  );
};
